...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("StudentsListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheStudentsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheStudentsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheStudentsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheStudentsListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheStudentsListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheStudentsListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheStudentsListGenerated.onTable(defaultTableId).iPressRow(0);
            Then.onTheStudentsObjectPageGenerated.iSeeThisPage();
        });
